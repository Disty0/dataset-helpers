...
booru_char_features_prompt = "These are the common tags for features of the characters in the image in random order. Use them for guidance but they might not be for the same outfit as the one in the image:"
booru_tag_prompt = "These are the tags for the image in random order, you can use them for guidance but don't add them to the description as tags: {}"
